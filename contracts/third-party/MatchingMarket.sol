...
contract SimpleMarket is EventfulMarket, DSMath, DSAuth {
        ...
        returns (bool)
    {
        ...
        uint256 fee = spend / 200;
        uint256 net_spend = sub(spend, fee);

        require( offer.buy_gem.transferFrom(msg.sender, offer.owner, net_spend) );
        require( offer.buy_gem.transferFrom(msg.sender, owner, fee) );
